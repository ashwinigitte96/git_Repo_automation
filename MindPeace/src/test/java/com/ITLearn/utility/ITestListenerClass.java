...
public class ITestListenerClass implements ITestListener{
	...
	public void onTestStart(ITestResult result) {
	  ...
	  System.out.println("Name of the test method successfully excuted : "+result.getName());
	   ...
	   test.log(Status.PASS, MarkupHelper.createLabel("Name of the test method successfully excuted: "+result.getName(),ExtentColor.GREEN));
	  }
	  ...
	  public void onTestFailure(ITestResult result) {
	    ...
	    //on failure of any test case it will save screenshot 
